...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#343434] mt-[80px] py-4 sm:py-0">
      <div className="w-full  mx-auto">
        <div className="w-full  flex justify-between bg-[#343434]">
          <div className="p-4 sm:p-6 md:p-12 pb-8 flex flex-col">
            <a href="/">
              <img src={'/icon3.svg'} alt="Hiro Ordinals Beta" className="max-w-[100rem] w-[150px] sm:w-[196px]" />
            </a>
            ...
            <div className="mt-10 flex flex-col md:flex-row justify-between text-center text-xs text-neutral-300 space-y-4 md:space-y-0">
              <div className="space-x-3 flex">
                <a href="https://twitter.com/ordinalscan">
                  ...
                  <img src="/twitter.svg" alt="github ordinalscan" className="w-[19px] sm:w-[32px]" />
                  {/*<TwitterLogoIcon className="inline-block w-5 h-5 text-neutral-0" />*/}
                </a>
                <a href="https://medium.com/@ordinalscan">
                  <img src="/medium.svg" alt="medium ordinalscan" className="w-[19px] sm:w-[32px]" />
                </a>
          ...
          <div className="p-4 sm:p-6 md:p-12 pb-8 grid sm:flex  text-[#929292] gap-x-[3rem] text-[14px] gap-y-[0.5rem]">
